...
- **复用作者习惯**：若工作区已有 `.story/作者记忆/作者画像.md`，写前读取匹配的 active 条目；硬门禁、当前请求和本篇设定优先。捕获与冲突按 [references/author-memory.md](references/author-memory.md)，只用 `scripts/author_memory_commit.py` 写入。
