...
**设置**：表面身份+隐藏身份，通过行为细节泄露（非叙述者说明），回看至少3处暗示。

**揭示**：用场景同时揭示身份和动机，不让角色自说"其实我是XX"，时机选在读者最不期待时。
...
**设置**：所有叙述都是事实但不是全部事实；叙述者解读引导读者走错方向；关键信息被「合理地」跳过或淡化；叙述者自己也信了这套叙事。

**揭示**：引入另一角色视角/证词，展示主角「没看到」的场景，用证据打破认知。
...
关键原则：叙述者必须真诚地相信自己的视角——不是在骗读者，他自己也被骗了。

### 3. 动机反转

角色做某事的真正原因与读者以为的不同。

**设置**：给角色一个「表面动机」让读者觉得合理；真正动机藏在表面之下；行为细节与表面动机有微小矛盾（矛盾不要太大）。

**揭示**：在高压场景中角色被迫二选一，表面动机指向选A但角色选了B，暴露真正动机。
...
**设置**：用叙述技巧让读者以为A在B之前，实际B在A之前。关键：不撒谎，只调整叙述顺序。时态、季节、物品新旧是天然时间线索。

**揭示**：一个不可能存在的时间矛盾/角色提到「还没发生」的事/物品状态与时间线不符。
...
**设置**：给读者一个来自可靠来源的「事实」，所有人物基于此行动，在后果中埋下矛盾证据。

**揭示**：新证据直接否定旧「事实」，读者和主角同时发现被骗，前面所有剧情获得新解读。
...
核心区别：信息反转核心是「一条假信息」，是认知层面的——你以为世界是A，其实是B。
...
红鲱鱼必须在故事里有自己的功能（推进情节/增加趣味），只是不是反转的答案。
...
类似鬼片推开门什么都没有->松口气->回头撞鬼。先给出"应该不会发生"的预期让读者放松，然后意外以反转形式发生。
