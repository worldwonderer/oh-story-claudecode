...
- **编排/题材定位.md**：题材核心梗三分法+对标分析（参考 genre-frameworks-unified.md §核心梗解析）
...
- **大纲/卷纲_第X卷.md**：每卷的爽点节奏+人物弧线+伏笔规划（参考 outline-arrangement.md §大纲三层结构法）
- **编排/情绪_第X卷.md**：卷级情绪弧线+字数分配（参考 emotional-arc-design.md §六种弧线速查）
- **编排/反转登记.md**：全书反转清单+误导管理（参考 reversal-toolkit.md §五种反转类型）
...
├── 大纲/
│   ├── 大纲.md                # 全书卷级结构
│   ├── 卷纲_第一卷.md         # 每卷一个，含爽点节奏+人物弧线+伏笔
│   └── 细纲_第001章.md        # 每章一个，与正文一一对应
├── 编排/
│   ├── 钩子_第XXX章.md        # 章级（可批量：钩子_第XXX-YYY章.md）
│   ├── 情绪_第X卷.md          # 卷级情绪弧线
│   ├── 反转登记.md            # 全书级反转管理
│   └── 题材定位.md            # 全书级题材核心梗
├── 正文/
...
| 编排/钩子_第N章.md | 章 | Phase 3 | Phase 4 写该章前 |
| 编排/情绪_第X卷.md | 卷 | Phase 3 | Phase 4 写卷首章前 |
| 编排/反转登记.md | 全书 | Phase 3 | Phase 4 写高潮章节前 |
| 编排/题材定位.md | 全书 | Phase 2 | Phase 3 大纲、每卷开始前 |
| 追踪/伏笔.md | 全书 | Phase 3 起 | Phase 4 每章写作前 |
| 追踪/时间线.md | 全书 | Phase 3 起 | Phase 4 每章写作前 |

**缺失文件回退**：所有新增文件是可选增强。缺失时 agent 降级到当前行为，不报错不阻塞——钩子直接内联设计，情绪/反转信息在卷纲或大纲中体现，伏笔/时间线不检查。

**文件组织原则：**
- **人物一个一个文件**：`角色/角色名.md`，方便按需读取
- **势力一个一个文件**：`势力/势力名.md`，组织/门派/家族/国家等
- **世界观按主题拆分**：背景、力量体系、社会结构等各自独立
- **细纲一章一个文件**：`细纲_第XXX章.md`，与正文一一对应
- **正文按章拆分**：每章一个文件，`第XXX章_章名.md`
- **钩子支持批量**：长篇可按卷合并为 `钩子_第XXX-YYY章.md`
...
1. **读取上下文**（按需加载，缺失则跳过）：
   ...
   - (2) `大纲/细纲_第{N}章.md` — 本章细纲
   - (3) `编排/钩子_第{N}章.md`（如存在）— 本章钩子设计
   - (4) `追踪/伏笔.md`（如存在）— 待回收伏笔
