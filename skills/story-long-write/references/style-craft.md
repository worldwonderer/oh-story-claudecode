...
- **节奏**：叙述默认用逗号长句，短句只在钩子、意外信息和情绪最强处连着用；忌通篇同长度，也忌一长一短机械交替（句长标准见 anti-ai-writing.md 规则 3）
- **画面感**：调动五感，不只写"看到"
...
- [ ] **节奏交替**：叙述默认是逗号长句（句长标准见 anti-ai-writing.md 规则 3），短句只在钩子 / 意外信息 / 情绪最强处连着用；忌通篇同长度，也忌机械长短交替；快慢场景交替
