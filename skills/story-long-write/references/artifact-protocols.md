...
- 契约风险：{contract-safe / needs-justification / contract-break；needs-justification 写补强方式}

## 正式情节循环卡（1–3 万字为可调启发式；存于卷纲内；不另建单独循环文件）
...
- 风险等级：{contract-safe / needs-justification / contract-break；needs-justification 写补强方式}
