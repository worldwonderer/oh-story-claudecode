...
> 双线法、阵营手牌法、九条主线、套路模板、大框架拆解、故事构型、结构与人物关系。
...
大结构作为噱头吊着读者，类似拼多多砍一刀，每次接近完成又差一点。如马甲曝光线：每次都被质疑，每次都能打破质疑，但总是差一点曝光。
...
- 拉片时注意：画面到文字转化存在巨大鸿沟，需主动做视觉到文字的转译练习
...
每一层都是对上一层更具体的展开。天然形成多级结构，比先设计结构再往里填内容的做法更符合写作直觉。

结构不重要：结构是为故事服务的工具，不是故事必须遵循的模具。细化法本身就是最好的结构。
