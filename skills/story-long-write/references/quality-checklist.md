...
参 `reader-contract-and-progression.md`。先问“无毒吗”，再问“好看吗”：**无毒不等于好看**，没有 contract-break 只代表不踩雷，还要确认情绪兑现足够强。

- [ ] 读者契约：本章/本卷是否兑现开篇承诺，还是把核心卖点交给机构、配角或偶然性？风险标记：contract-safe / needs-justification / contract-break。
