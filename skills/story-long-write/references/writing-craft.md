...
任务卡点不是多写流程，而是让角色想办成一件具体事时被卡住一下，并卡出变化。

公式：要办的事 → 卡住的点 → 角色选择/付代价 → 卡出的变化。
...
删掉试试：删掉后没有信息、情绪、关系、代价或伏笔损失，就不是有用卡点。
...
任务卡点写法同样按三维度揉进：发生 = 事情办不下去；感知 = 被退回的纸、扣住的物件、停住的动作、对方半句话等具体凭据；反应 = 角色改策略、付代价、求助、硬闯、退让或记下一笔。不要把“为什么被卡住”解释成一段说明书。
