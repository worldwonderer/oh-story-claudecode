...
| 铺垫/日常/关系升温 | 密＋疏 | **不是通篇中等分辨率**——仍要挑一处推到慢镜头（落到一个具体的人／物／一次来回，给它一个别处搬不来的细节），其余压到一两句 |

原则：一章里详写的 beat 集中在情绪节点，过场坚决压缩。**低压章同样适用**——没有爽点不等于可以通篇匀速；实测「每处都办到中等分辨率」正是读者说的「像叙事」「太AI」的来源。读者记住的是密处的画面，疏处只是把他们快速送到下一个爽点。密度有起伏，节奏才有呼吸。
