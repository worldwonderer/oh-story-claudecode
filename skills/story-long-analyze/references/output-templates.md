...
全书概要：{500-1000字，高信息密度，涵盖主要剧情线的阶段性发展，体现体系感和成长线。突出核心人物及其作用、关键转折点、因果关系}
章节索引：| 章节 | 标题 | 字数 |
...
| 概要 | {150-400字因果链，含核心角色及定位、关键地点、起承转合、关键道具（如有）、对主角/世界的影响} |
...
3. <0.5 按主题聚类，标`[聚类生成]`（≥5个才建条）
4. 无法归类写入`散落情节.md`，不要强行分配到不相关的剧情
