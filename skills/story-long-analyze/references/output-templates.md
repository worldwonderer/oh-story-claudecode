...
输出 `拆文库/{书名}/文风画像.md`。整书级写作技法视图，供 story-long-write 日更循环喂给 narrative-writer。

**字段速查**：

| 段落 | 内容 | 必标 confidence | 上限 |
|---|---|---|---|
| 生成元信息 | 源数据 mtime + 采样章节号 + degenerate flag | 否 | <100 字 |
...
| **原文锚点片段** | **4-6 段 × 300-500 字**，按 tone 分类，标"出处 + 行号 + 示范点" | 否 | ~2400 字 |
