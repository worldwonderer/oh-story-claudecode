# 核心梗解析与微创新设计
核心梗三代理论、微创新五法、冲突网络、金手指匹配、事业线/爱情线设计。构思和验证大纲时对照使用。
...
结构共性：中间写法一致(逐个暧昧不确认关系，结局确认)。后宫注意：不能和一个确认后再攻略下一个(显渣男)。修罗场三处理：一笔带过/关联回事业线(最推荐)/被害人设梗。炒股结尾建议开放性结局。
