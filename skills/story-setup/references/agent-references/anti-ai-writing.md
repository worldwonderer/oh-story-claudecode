...
叙述（旁白）默认写成**逗号长句**：一句用逗号串起 2-4 个动作或信息，再落句号；逗号之间 8-12 字，整句 20-30 字。短句不是叙述的默认写法，只在下面三种地方连着用，用完就回到逗号长句。

| 场景 | 句长 | 示例（长篇语料原句） |
|------|------|------|
| 日常 / 推进 / 描写（多数叙述句） | 逗号之间 8-12 字，整句 20-30 字 | 阴冷潮湿的气息扑面而来，身下铺着一层薄薄的稻草，湿漉漉地粘在皮肤上。 |
| 打斗 / 冲突 / 情绪最强处 | 连着几个短句，一句一段，越接近顶点越短 | 可他现在什么也做不了。他只能努力活着。活下去。 |
| 悬念钩子 / 抖出意外信息 | 单句短段 | 虽然过程并不美好。 |
| 对话 | 口语化，长短随角色 | "你疯了？""可能吧。" |

连着用短句只有三种场合：悬念钩子、抖出意外信息、情绪最强处。真实语料里这几句是一句一段连排下来，不是挤在同一段里连打句号；这几句写完立刻回到逗号长句。
...
- [ ] **句长达标**：叙述默认是逗号长句（逗号之间 8-12 字、整句 20-30 字，规则 3）；打斗 / 冲突 / 情绪最强处才连用短句，写完回到逗号长句；没有连着的 ≤5 字碎片，没有通篇短句像提纲
