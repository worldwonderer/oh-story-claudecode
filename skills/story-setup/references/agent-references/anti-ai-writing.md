...
去AI味删过头的反向指纹。每句都压到最短、结构虚词扫光、每个动作都补一个「了一下」式轻反应。单句看着干净，连读像提纲，读者的体感是"不流畅、喘不上气"。删减的目标是删废话（解释、注水、凑数），不是删中文的自然冗余。

| 表现 | 修法 |
|---|---|
| 非峰值叙述句也全部压成最短句 | 重拍句（动作/情绪/悬念峰值）保持短促；铺垫、过渡、日常动作写成自然白话句，保留 了/的/就/的时候 等结构虚词 |
| 「停了一下/拍了两下/松了半圈」式微动作高密度复现（check-ai-patterns.js 报 micro-action-tic） | 合并动作，换具体细节；不是每个动作都要接一个反应尾巴 |
...
- [ ] **无电报体**：非峰值叙述保留自然虚词，「了X下」式微动作不复读（micro-action-tic 不报警），删强调副词未伤语义
