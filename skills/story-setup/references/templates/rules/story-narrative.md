...
2. **Voice Profile 一致**：角色对话必须匹配角色设定中的 voice_profile（语气、用词习惯、感叹号使用频率等）。
...
6. **禁止 AI 腔**（红线级约束）：
   ...
   - 禁止所有角色说话方式一样，每个角色必须符合 voice_profile 7 维（口癖/节奏/信息偏好/立场/身份措辞/性格语气/进度态度）
...
3. 更新追踪/active.md：[2024-05-05] 新增灵力九层体系
```
