...
| — | `追踪/逐章记录/` | 创建空目录；导入章不伪造日更记录，续写后再逐章生成 |
| `章节/第N章_摘要.md` | `追踪/阶段摘要.md` | 每 10 章汇总一行，不足 10 章的末段也写入；另生成卷级总览 |
| `剧情/散落情节.md` | `大纲/大纲.md` 附录或对应卷纲 | 合并到相关卷的大纲 |
| — | `追踪/上下文.md` | 生成写作状态摘要，顶层区块恰好 11 个（最后生成，依赖角色状态与伏笔） |
...
- [ ] 追踪/上下文.md 写作状态摘要已填写，顶层区块恰好是状态摘要格式规定的 11 个
- [ ] 散落情节已合并到相关卷纲或大纲附录
