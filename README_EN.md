...
> **Candidate refactor — six-dimensional long-form analysis:** long-form analysis keeps the golden three chapters and reduces the full-text stage to a five-column mechanical index, 20-column structure blocks, and three self-contained global reports, with checkpoint protection. Rerun `/story-setup` and start a new session; candidate `agents_version` is 30.
>
